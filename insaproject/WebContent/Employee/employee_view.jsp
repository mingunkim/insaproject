			...
			<div class='panel panel-primary'>
				...
				<div class='panel-body'>
					...
					<div class='col-md-3 col-md-offset-5 col-xs-6 col-xs-offset-5'>
						<button type='button' class='btn btn-info' id='btnList'>검색으로</button>
					</div>
				</div>
			</div>
		</div>
...
<script>
document.getElementById("btnList").onclick = function() { //검색으로
	location.href = "/insaproject/index.jsp?inc=./Employee/employee_list.jsp";
}
</script>
</html>